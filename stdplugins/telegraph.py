...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            await event.edit("**Downloaded to `{}`**\n`in {} seconds.`".format(downloaded_file_name, ms))
            ...
            ms = (end - start).seconds
            await event.edit("**Pasted to [Telegraph](https://telegra.ph/{})**\n`in {} seconds.`".format(response["path"], ms), link_preview=True)
    else:
